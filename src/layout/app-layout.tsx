...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['super-admin', 'admin', 'staff-member'];
  ...
  const { data, error, isLoading } = useSWR<InstituteInterface[]>(
    ...
    () => getInstitutes({ tenant_id: session?.user?.tenantId }),
  );
  loading = isLoading;
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Staff', path: '/staff', entity: 'staff', service: AccessServiceEnum.PROJECT, icon: FiUserPlus },
