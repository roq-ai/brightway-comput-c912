...
import { getCourseFeeById } from 'apiSdk/course-fees';
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Course Fee Detail View
          </Text>
          {hasAccess('course_fee', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/course-fees/edit/${data?.id}`} passHref legacyBehavior>
              <Button
