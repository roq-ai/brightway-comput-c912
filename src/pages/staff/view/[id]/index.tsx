...
function StaffViewPage() {
  ...
  const { data, error, isLoading, mutate } = useSWR<StaffInterface>(
    ...
    () =>
      getStaffById(id, {
        relations: ['institute', 'user', 'attendance', 'payroll'],
      }),
  );
              ...
              {hasAccess('attendance', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                <Stack spacing={2} mb={8}>
                  <Flex justifyContent="space-between">
                    ...
                    <NextLink passHref href={`/attendances/create?staff_id=${data?.id}`}>
              ...
              {hasAccess('payroll', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                <Stack spacing={2} mb={8}>
                  <Flex justifyContent="space-between">
                    ...
                    <NextLink passHref href={`/payrolls/create?staff_id=${data?.id}`}>
                      <Button colorScheme="blue" mr="4" as="a">
                        Create
                      </Button>
                    </NextLink>
