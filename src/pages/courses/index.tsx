...
function CourseListPage() {
  ...
  const { data, error, isLoading, mutate } = useSWR<CourseInterface[]>(
    ...
    () =>
      getCourses({
        relations: ['institute', 'course_fee.count'],
      }),
  );
          ...
          <TableContainer>
            <Table variant="simple">
              <Thead>
                <Tr>
                  <Th>name</Th>
                  {hasAccess('institute', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && <Th>institute</Th>}
                  {hasAccess('course_fee', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && <Th>course_fee</Th>}
                  <Th>Actions</Th>
                </Tr>
              </Thead>
              <Tbody>
